      ...
      .add("NF3e",
        new StructType()
          ...
          .add("infNF3e", new StructType()
            .add("autXML", ArrayType(
              new StructType()
                .add("CNPJ", StringType, true)
                .add("CPF", StringType, true), true), true)
            .add("_versao", StringType, true)
              .add("NFdet", new StructType()
                  .add("det", ArrayType( new StructType()
                        ...
                        .add("detItem", new StructType()
                          .add("gAdBand", ArrayType(
                            new StructType()
                              .add("dIniAdBand", StringType, true)
                              .add("dFimAdBand", StringType, true)
                              .add("tpBand", StringType, true)
                              .add("vAdBand", DoubleType, true), true), true)
                          .add("gContab", ArrayType(
                            new StructType()
                              .add("cContab", StringType, true)
                              .add("tpLanc", StringType, true)
                              .add("vContab", DoubleType, true)
                              .add("xContab", StringType, true), true), true)
                          .add("gTarif", ArrayType(
                            new StructType()
                              .add("dIniTarif", StringType, true)
                              .add("dFimTarif", StringType, true)
                              .add("tpAto", StringType, true)
                              .add("nAto", StringType, true)
                              .add("anoAto", StringType, true)
                              .add("tpTarif", StringType, true)
                              .add("cPosTarif", StringType, true)
                              .add("uMed", StringType, true)
                              .add("vTarifHom", DoubleType, true)
                              .add("vTarifAplic", DoubleType, true)
                              .add("motDifTarif", StringType, true), true), true)
                              ...
                              new StructType()
                                ...
                                .add("gMedicao", new StructType()
                                    .add("gMedida", new StructType()
                                        ...
                                        .add("vMedPerdaTec", DoubleType, true)
              ...
              .add("dest",
                new StructType()
                  ...
                  .add("enderDest", new StructType()
                      ...
                      .add("fone", StringType, true), true), true
              )
              ...
              .add("gSCEE", new StructType()
                .add("tpPartComp", StringType, true)
                .add("gConsumidor", ArrayType(
                  new StructType()
                    .add("idAcessGer", StringType, true)
                    .add("vPotInst", DoubleType, true)
                    .add("tpFonteEnergia", StringType, true)
                    .add("enerAloc", DoubleType, true)
                    .add("tpPosTar", StringType, true)), true)
                .add("gSaldoCred", ArrayType( new StructType()
                    .add("tpPosTar", StringType, true)
                    .add("vSaldAnt", DoubleType, true)
                    .add("vCredExpirado", DoubleType, true)
                    .add("vSaldAtual", DoubleType, true)
                    .add("vCredExpirar", DoubleType, true)
                    .add("CompetExpirar", StringType, true)), true), true)
              .add("gTarif", ArrayType(new StructType()
                  .add("dIniTarif", StringType, true)
                  .add("dFimTarif", StringType, true)
                  .add("tpAto", StringType, true)
                  .add("nAto", StringType, true)
                  ...
                  .add("vTarifHom", DoubleType, true)
                  .add("vTarifAplic", DoubleType, true)
                  .add("motDifTarif", StringType, true)), true)
              .add("gAdBand", ArrayType(new StructType()
                  .add("dIniAdBand", StringType, true)
                  .add("dFimAdBand", StringType, true)
                  .add("tpBand", StringType, true)
                  .add("vAdBand", DoubleType, true)
                  .add("vAdBandAplic", DoubleType, true)
                  .add("motDifBand", StringType, true)), true)
