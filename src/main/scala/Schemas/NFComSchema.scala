        ...
        .add("infNFCom", new StructType()
          ...
          .add("det", ArrayType(
            new StructType()
              ...
              .add("gProcRef", new StructType()
                ...
                .add("vPIS", DoubleType, true)
                .add("vCOFINS", DoubleType, true)
                .add("vFCP", DoubleType, true)  // Campo adicionado
          ...
          .add("gFat", new StructType()
            ...
            .add("enderCorresp", new StructType()
              ...
              .add("xLgr", StringType, true)
              .add("xMun", StringType, true)
              .add("email", StringType, true)  // Campo adicionado
              .add("fone", StringType, true))  // Campo adicionado
            .add("gPIX", new StructType()
              .add("urlQRCodePIX", StringType, true)))
          .add("gFatCentral", new StructType()
            .add("CNPJ", StringType, true)
            .add("cUF", StringType, true))
          .add("gFidelidade", new StructType()  // Novo campo adicionado
            .add("dRefResgPts", StringType, true)
            .add("dRefSaldoPts", StringType, true)
            .add("qtdPtsResg", DoubleType, true)
            .add("qtdSaldoPts", DoubleType, true))
          .add("gRespTec", new StructType()
            .add("CNPJ", StringType, true)
            .add("email", StringType, true)
            .add("fone", StringType, true)
            .add("xContato", StringType, true)
            .add("hashCSRT", StringType, true)  // Campo adicionado
            .add("idCSRT", StringType, true))   // Campo adicionado
          .add("ide", new StructType()
            ...
            .add("gCompraGov", new StructType()
                .add("pRedutor", DoubleType, true)
                .add("tpEnteGov", LongType, true)
                .add("tpOperGov", LongType, true))
          ...
          .add("total", new StructType()
            .add("IBSCBSTot", new StructType()
              ...
              .add("gEstornoCred", new StructType()
                .add("vCBSEstCred", DoubleType, true)
                .add("vIBSEstCred", DoubleType, true))
