    ...
    new StructType()
      .add("protNFe", new StructType()
        .add("infProt", new StructType()
          ...
          .add("cMsg", StringType, nullable = true)
          .add("xMsg", StringType, nullable = true))
      ...
      .add("NFe", new StructType()
        .add("infNFe", new StructType()
          ...
          .add("agropecuario", new StructType()
            .add("defensivo", new StructType()
              .add("CPFRespTec", StringType, nullable = true)
              .add("nReceituario", StringType, nullable = true))
            .add("guiaTransito", new StructType()
              .add("UFGuia", StringType, nullable = true)
              .add("nGuia", StringType, nullable = true)
              .add("serieGuia", StringType, nullable = true)
              .add("tpGuia", StringType, nullable = true)))
          .add("ide", new StructType()
            ...
            .add("tpNFDebito", StringType, nullable = true)
            .add("tpNFCredito", StringType, nullable = true)
            ...
            .add("gCompraGov", new StructType()
              .add("tpEnteGov", StringType, nullable = true)
              .add("pRedutor", DoubleType, nullable = true)
              .add("tpOperGov", StringType, nullable = true))
            .add("gPagAntecipado", new StructType()
          ...
          .add("transp", new StructType()
            ...
            .add("balsa", StringType, nullable = true)
          ...
          .add("total", new StructType()
            ...
            .add("ISSQNtot", new StructType()
              ...
              .add("vBC", DoubleType, nullable = true)
              .add("vCOFINS", DoubleType, nullable = true)
              .add("vDeducao", DoubleType, nullable = true)
              .add("vDescCond", DoubleType, nullable = true)
              .add("vDescIncond", DoubleType, nullable = true)
            ...
            .add("retTrib", new StructType()
              ...
              .add("vRetPrev", DoubleType, nullable = true))
            .add("ISTot", new StructType()
              .add("vIS", DoubleType, nullable = true))
            .add("IBSCBSTot", new StructType()
              .add("vBCIBSCBS", DoubleType, nullable = true)
              .add("gCBS", new StructType()
                .add("vCBS", DoubleType, nullable = true)
                .add("vCredPres", DoubleType, nullable = true)
                .add("vCredPresCondSus", DoubleType, nullable = true)
                .add("vDevTrib", DoubleType, nullable = true)
                .add("vDif", DoubleType, nullable = true))
              .add("gEstornoCred", new StructType()
                .add("vIBSEstCred", DoubleType, nullable = true)
                .add("vCBSEstCred", DoubleType, nullable = true))
              .add("gIBS", new StructType()
                ...
                .add("vCredPres", DoubleType, nullable = true)
                .add("vCredPresCondSus", DoubleType, nullable = true))
              .add("gMono", new StructType()
                .add("vCBSMono", DoubleType, nullable = true)
                .add("vCBSMonoRet", DoubleType, nullable = true)
                .add("vCBSMonoReten", DoubleType, nullable = true)
                .add("vIBSMono", DoubleType, nullable = true)
                .add("vIBSMonoRet", DoubleType, nullable = true)
                .add("vIBSMonoReten", DoubleType, nullable = true))
              )
            .add("vNFTot", DoubleType, nullable = true)
        )
      )
    )
  }
