        ...
        .add("infCte", new StructType()
            ...
            .add("IBSCBS", new StructType()
              ...
              .add("gIBSCBS", new StructType()
                ...
                .add("gTribRegular", new StructType()
                  .add("CSTReg", StringType, true)
                  .add("cClassTribReg", StringType, true)
                  .add("pAliqEfetRegCBS", DoubleType, true)
                  .add("pAliqEfetRegIBSMun", DoubleType, true)
                  .add("pAliqEfetRegIBSUF", DoubleType, true)
                  .add("vTribRegCBS", DoubleType, true)
                  .add("vTribRegIBSMun", DoubleType, true)
                  .add("vTribRegIBSUF", DoubleType, true)
                )
                .add("gTribCompraGov", new StructType()
                  .add("pAliqCBS", DoubleType, true)
                  .add("pAliqIBSMun", DoubleType, true)
                  .add("pAliqIBSUF", DoubleType, true)
                  .add("vTribCBS", DoubleType, true)
                  .add("vTribIBSMun", DoubleType, true)
                  .add("vTribIBSUF", DoubleType, true)
                )
              )
            )
          ...
          .add("infCTeNorm", new StructType()
            ...
            .add("infDoc", new StructType()
              ...
              .add("infDCe", ArrayType(new StructType()
                .add("chave", StringType, true)), true)
            ...
            .add("infModal", new StructType()
              ...
              .add("duto", new StructType()
                ...
                .add("dIni", StringType, true)
                .add("vTar", DoubleType, true)
                .add("codPontoEntrada", StringType, true)
                .add("codPontoSaida", StringType, true)
                .add("tpContratacao", StringType, true))
