    ...
    (0 to diasAntesInicio.until(diasAntesFim).getDays).foreach { dayOffset =>
      ...
      if (parquetPathExists) {
        ...
        val parsedDF = xmlDF.withColumn("parsed", from_xml($"xml", schema))
          ...
          // 4. Seleciona as colunas desejadas
          val selectedDF = parsedDF.select(
            ...
            .select(
                ...
                $"infprot_cstat",
                $"infprot_dhrecbto",
                $"det.DFeReferenciado".as("DFeReferenciado"),
                $"det.vItem".as("vItem"),
                ...
                $"det.prod.cBenefRBC".as("cBenefRBC"),
                $"det.prod.NCM".as("NCM"),
                ...
                $"det.prod.xLote".as("xLote"),
                $"det.prod.DI".as("DI"),
                $"det.prod.gCred".as("gCred"),
                $"det.prod.infProdEmb.qVolEmb".as("infProdEmb_qVolEmb"),
                $"det.prod.infProdEmb.uEmb".as("infProdEmb_uEmb"),
                $"det.prod.infProdEmb.xEmb".as("infProdEmb_xEmb"),
                ...
                $"det.prod.NVE".as("NVE"),
                $"det.prod.detExport".as("detExport"),
                ...
                $"det.prod.comb.encerrante.nBico".as("encerrante_nBico"),
                $"det.prod.comb.encerrante.nBomba".as("encerrante_nBomba"),
                $"det.prod.comb.encerrante.nTanque".as("encerrante_nTanque"),
                $"det.prod.comb.encerrante.vEncFin".as("encerrante_vEncFin"),
                $"det.prod.comb.encerrante.vEncIni".as("encerrante_vEncIni"),
                $"det.prod.comb.origComb".as("comb_origComb"),
                ...
                $"det.prod.rastro".as("rastro"),
                $"det.imposto.IBSCBS.CST".as("IBSCBS_CST"),
                $"det.imposto.IBSCBS.cClassTrib".as("IBSCBS_cClassTrib"),
                $"det.imposto.IBSCBS.indDoacao".as("IBSCBS_indDoacao"),
                $"det.imposto.IBSCBS.gIBSCBS.vBC".as("IBSCBS_gIBSCBS_vBC"),
                $"det.imposto.IBSCBS.gIBSCBS.vIBS".as("IBSCBS_gIBSCBS_vIBS"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.gDif.pDif".as("gIBSUF_gDif_pDif"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.gDif.vDif".as("gIBSUF_gDif_vDif"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.gDevTrib.vDevTrib".as("gIBSUF_gDevTrib_vDevTrib"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.gRed.pRedAliq".as("gIBSUF_gRed_pRedAliq"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.gRed.pAliqEfet".as("gIBSUF_gRed_pAliqEfet"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.pIBSUF".as("gIBSCBS_gIBSUF_pIBSUF"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSUF.vIBSUF".as("gIBSCBS_gIBSUF_vIBSUF"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.gDif.pDif".as("gIBSMun_gDif_pDif"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.gDif.vDif".as("gIBSMun_gDif_vDif"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.gDevTrib.vDevTrib".as("gIBSMun_gDevTrib_vDevTrib"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.gRed.pRedAliq".as("gIBSMun_gRed_pRedAliq"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.gRed.pAliqEfet".as("gIBSMun_gRed_pAliqEfet"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.pIBSMun".as("gIBSCBS_gIBSMun_pIBSMun"),
                $"det.imposto.IBSCBS.gIBSCBS.gIBSMun.vIBSMun".as("gIBSCBS_gIBSMun_vIBSMun"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.pCBS".as("gIBSCBS_gCBS_pCBS"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.vCBS".as("gIBSCBS_gCBS_vCBS"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.gDif.pDif".as("gCBS_gDif_pDif"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.gDif.vDif".as("gCBS_gDif_vDif"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.gDevTrib.vDevTrib".as("gCBS_gDevTrib_vDevTrib"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.gRed.pAliqEfet".as("gCBS_gRed_pAliqEfet"),
                $"det.imposto.IBSCBS.gIBSCBS.gCBS.gRed.pRedAliq".as("gCBS_gRed_pRedAliq"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.CSTReg".as("gIBSCBS_gTribRegular_CSTReg"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.cClassTribReg".as("gIBSCBS_gTribRegular_cClassTribReg"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.pAliqEfetRegIBSUF".as("gIBSCBS_gTribRegular_pAliqEfetRegIBSUF"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.vTribRegIBSUF".as("gIBSCBS_gTribRegular_vTribRegIBSUF"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.pAliqEfetRegIBSMun".as("gIBSCBS_gTribRegular_pAliqEfetRegIBSMun"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.vTribRegIBSMun".as("gIBSCBS_gTribRegular_vTribRegIBSMun"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.pAliqEfetRegCBS".as("gIBSCBS_gTribRegular_pAliqEfetRegCBS"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribRegular.vTribRegCBS".as("gIBSCBS_gTribRegular_vTribRegCBS"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribCompraGov.pAliqIBSUF".as("gTribCompraGov_pAliqIBSUF"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribCompraGov.vTribIBSUF".as("gTribCompraGov_vTribIBSUF"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribCompraGov.pAliqIBSMun".as("gTribCompraGov_pAliqIBSMun"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribCompraGov.vTribIBSMun".as("gTribCompraGov_vTribIBSMun"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribCompraGov.pAliqCBS".as("gTribCompraGov_pAliqCBS"),
                $"det.imposto.IBSCBS.gIBSCBS.gTribCompraGov.vTribCBS".as("gTribCompraGov_vTribCBS"),
                $"det.imposto.IBSCBS.gIBSCBSMono.vTotIBSMonoItem".as("gIBSCBSMono_vTotIBSMonoItem"),
                $"det.imposto.IBSCBS.gIBSCBSMono.vTotCBSMonoItem".as("gIBSCBSMono_vTotCBSMonoItem"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoPadrao.qBCMono".as("gMonoPadrao_qBCMono"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoPadrao.adRemIBS".as("gMonoPadrao_adRemIBS"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoPadrao.adRemCBS".as("gMonoPadrao_adRemCBS"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoPadrao.vIBSMono".as("gMonoPadrao_vIBSMono"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoPadrao.vCBSMono".as("gMonoPadrao_vCBSMono"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoReten.qBCMonoReten".as("gMonoReten_qBCMonoReten"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoReten.adRemIBSReten".as("gMonoReten_adRemIBSReten"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoReten.vIBSMonoReten".as("gMonoReten_vIBSMonoReten"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoReten.adRemCBSReten".as("gMonoReten_adRemCBSReten"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoReten.vCBSMonoReten".as("gMonoReten_vCBSMonoReten"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoRet.qBCMonoRet".as("gMonoRet_qBCMonoRet"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoRet.adRemIBSRet".as("gMonoRet_adRemIBSRet"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoRet.vIBSMonoRet".as("gMonoRet_vIBSMonoRet"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoRet.adRemCBSRet".as("gMonoRet_adRemCBSRet"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoRet.vCBSMonoRet".as("gMonoRet_vCBSMonoRet"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoDif.pDifIBS".as("gMonoDif_pDifIBS"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoDif.vIBSMonoDif".as("gMonoDif_vIBSMonoDif"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoDif.pDifCBS".as("gMonoDif_pDifCBS"),
                $"det.imposto.IBSCBS.gIBSCBSMono.gMonoDif.vCBSMonoDif".as("gMonoDif_vCBSMonoDif"),
                $"det.imposto.IBSCBS.gTransfCred.vIBS".as("gTransfCred_vIBS"),
                $"det.imposto.IBSCBS.gTransfCred.vCBS".as("gTransfCred_vCBS"),
                $"det.imposto.IBSCBS.gAjusteCompet.competApur".as("gAjusteCompet_competApur"),
                $"det.imposto.IBSCBS.gAjusteCompet.vIBS".as("gAjusteCompet_vIBS"),
                $"det.imposto.IBSCBS.gAjusteCompet.vCBS".as("gAjusteCompet_vCBS"),
                $"det.imposto.IBSCBS.gCredPresOper.vBCCredPres".as("gCredPresOper_vBCCredPres"),
                $"det.imposto.IBSCBS.gCredPresOper.cCredPres".as("gCredPresOper_cCredPres"),
                $"det.imposto.IBSCBS.gCredPresOper.gIBSCredPres.pCredPres".as("gIBSCredPres_pCredPres"),
                $"det.imposto.IBSCBS.gCredPresOper.gIBSCredPres.vCredPres".as("gIBSCredPres_vCredPres"),
                $"det.imposto.IBSCBS.gCredPresOper.gIBSCredPres.vCredPresCondSus".as("gIBSCredPres_vCredPresCondSus"),
                $"det.imposto.IBSCBS.gCredPresOper.gCBSCredPres.pCredPres".as("gCBSCredPres_pCredPres"),
                $"det.imposto.IBSCBS.gCredPresOper.gCBSCredPres.vCredPres".as("gCBSCredPres_vCredPres"),
                $"det.imposto.IBSCBS.gCredPresOper.gCBSCredPres.vCredPresCondSus".as("gCBSCredPres_vCredPresCondSus"),
                $"det.imposto.IBSCBS.gCredPresIBSZFM.competApur".as("gCredPresIBSZFM_competApur"),
                $"det.imposto.IBSCBS.gCredPresIBSZFM.tpCredPresIBSZFM".as("gCredPresIBSZFM_tpCredPresIBSZFM"),
                $"det.imposto.IBSCBS.gCredPresIBSZFM.vCredPresIBSZFM".as("gCredPresIBSZFM_vCredPresIBSZFM"),
                $"det.imposto.IBSCBS.gEstornoCred.vIBSEstCred".as("gEstornoCred_vIBSEstCred"),
                $"det.imposto.IBSCBS.gEstornoCred.vCBSEstCred".as("gEstornoCred_vCBSEstCred"),
                ...
                $"det.imposto.ICMS.ICMS90.pFCPST".as("ICMS90_pFCPST"),
                ...
                $"det.imposto.ICMS.ICMS90.vBCFCPST".as("ICMS90_vBCFCPST"),
                ...
                $"det.imposto.ICMS.ICMSPart.pMVAST".as("ICMSPart_pMVAST"),
                ...
                $"det.imposto.ICMS.ICMSSN900.pFCPST".as("ICMSSN900_pFCPST"),
                ...
                $"det.imposto.COFINSST.indSomaCOFINSST".as("COFINSST_indSomaCOFINSST"),
                $"det.imposto.COFINSST.pCOFINS".as("COFINSST_pCOFINS"),
                $"det.imposto.COFINSST.qBCProd".as("COFINSST_qBCProd"),
                $"det.imposto.COFINSST.vAliqProd".as("COFINSST_vAliqProd"),
                $"det.imposto.COFINSST.vBC".as("COFINSST_vBC"),
                $"det.imposto.COFINSST.vCOFINS".as("COFINSST_vCOFINS"),
                ...
                $"det.imposto.ISSQN.nProcesso".as("ISSQN_nProcesso"),
                $"det.imposto.ISSQN.vAliq".as("ISSQN_vAliq"),
                $"det.imposto.ISSQN.vBC".as("ISSQN_vBC"),
                $"det.imposto.ISSQN.vDeducao".as("ISSQN_vDeducao"),
                $"det.imposto.ISSQN.vDescCond".as("ISSQN_vDescCond"),
                $"det.imposto.ISSQN.vDescIncond".as("ISSQN_vDescIncond"),
                $"det.imposto.ISSQN.vOutro".as("ISSQN_vOutro"),
                $"det.imposto.ISSQN.vISSQN".as("ISSQN_vISSQN"),
                $"det.imposto.ISSQN.vISSRet".as("ISSQN_vISSRet"),
                $"det.imposto.IS.CSTIS".as("IS_CSTIS"),
                $"det.imposto.IS.cClassTribIS".as("IS_cClassTribIS"),
                $"det.imposto.IS.vBCIS".as("IS_vBCIS"),
                $"det.imposto.IS.pIS".as("IS_pIS"),
                $"det.imposto.IS.pISEspec".as("IS_pISEspec"),
                $"det.imposto.IS.uTrib".as("IS_uTrib"),
                $"det.imposto.IS.qTrib".as("IS_qTrib"),
                $"det.imposto.IS.vIS".as("IS_vIS"),
                ...
                $"det.obsItem.obsCont".as("obsItem_obsCont"),
                $"det.obsItem.obsFisco".as("obsItem_obsFisco")
            )
