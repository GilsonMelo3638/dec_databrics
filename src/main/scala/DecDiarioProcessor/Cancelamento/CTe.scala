...
object CTe {
  ...
  val tipoDocumentoCancelamento = "cte_cancelamento"
  val prataDocumento = "cancelamento"

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("ExtractCTeCancelamento").enableHiveSupport().getOrCreate()
    ...
    val ultimos10Dias = (1 to 23).map { diasAtras =>
