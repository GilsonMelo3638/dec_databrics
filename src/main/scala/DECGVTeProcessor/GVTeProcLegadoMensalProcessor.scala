...
object GVTeProcLegadoMensalProcessor {
  ...
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("ExtractGVTe").enableHiveSupport().getOrCreate()
    import spark.implicits._

    // Obter o esquema da classe CTeOSSchema
    val schema = GVTeSchema.createSchema() // Lista de anos com base nas variáveis externas
...
//GVTeProcLegadoMensalProcessor.main(Array())
