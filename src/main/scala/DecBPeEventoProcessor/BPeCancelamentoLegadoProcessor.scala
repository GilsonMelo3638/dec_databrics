...
object BPeCancelamentoLegadoProcessor {
  // Variáveis externas para o intervalo de meses e ano de processamento
  val ano = 2025
  val mesInicio = 3
  val mesFim = 3
  val tipoDocumento = "bpe_cancelamento"
  ...
  def main(args: Array[String]): Unit = {
    ...
    anoMesList.foreach { anoMes =>
      val parquetPath = s"/datalake/bronze/sources/dbms/dec/$tipoDocumento/201909_202502"
      ...
      repartitionedDF
        ...
        .save("/datalake/prata/sources/dbms/dec/bpe/cancelamento")
...
//BPeCancelamentoLegadoProcessor.main(Array())