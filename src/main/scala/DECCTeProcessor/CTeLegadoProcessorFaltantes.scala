  ...
  def main(args: Array[String]): Unit = {
    ...
    anoList.foreach { ano =>
      ...
      val selectedDF = parsedDF.select(
        ...
        $"parsed.CTe.infCte.compl.fluxo.pass".as("compl_fluxo_pass"),
        ...
        $"parsed.CTe.infCte.infCTeNorm.cobr.fat.nFat".as("cobr_fat_nfat"),
        $"parsed.CTe.infCte.infCTeNorm.cobr.fat.vDesc".as("cobr_fat_vdesc"),
        $"parsed.CTe.infCte.infCTeNorm.cobr.fat.vLiq".as("cobr_fat_vliq"),
        $"parsed.CTe.infCte.infCTeNorm.cobr.fat.vOrig".as("cobr_fat_vorig"),
        ...
        $"parsed.CTe.infCte.infCTeNorm.infCteSub.tomaICMS.refNFe".as("infctesub_tomaicms_refnfe"),
        ...
        $"parsed.CTe.infCte.infCTeNorm.infModal.aereo.natCarga.cInfManu".as("aereo_natcarga_cinfmanu"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.aereo.natCarga.xDime".as("aereo_natcarga_xdime"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.aereo.peri".as("aereo_peri"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.aereo.tarifa.CL".as("aereo_tarifa_cl"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.aereo.tarifa.cTar".as("aereo_tarifa_ctar"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.aereo.tarifa.vTar".as("aereo_tarifa_vtar"),
        ...
        $"parsed.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.CNPJ".as("multimodal_seg_infseg_cnpj"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.xSeg".as("multimodal_seg_infseg_xseg"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.multimodal.seg.nApol".as("multimodal_seg_napol"),
        $"parsed.CTe.infCte.infCTeNorm.infModal.multimodal.seg.nAver".as("multimodal_seg_naver"),
