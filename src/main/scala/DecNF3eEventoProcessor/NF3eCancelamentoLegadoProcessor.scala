...
object NF3eCancelamentoLegadoProcessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    anoMesList.foreach { anoMes =>
      val parquetPath = s"/datalake/bronze/sources/dbms/dec/$tipoDocumento/202307_202502"
      ...
      repartitionedDF
        ...
        .save("/datalake/prata/sources/dbms/dec/nf3e/cancelamento")
