...
object NFComProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.NFCom.infNFCom.ide.gCompraGov.pRedutor".as("ide_gCompraGov_pRedutor"),
      $"parsed.NFCom.infNFCom.ide.gCompraGov.tpEnteGov".as("ide_gCompraGov_tpEnteGov"),
      $"parsed.NFCom.infNFCom.ide.gCompraGov.tpOperGov".as("ide_gCompraGov_tpOperGov"),
