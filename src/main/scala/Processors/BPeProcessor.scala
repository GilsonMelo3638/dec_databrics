...
object BPeProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.BPe.infBPe.comp.IE".as("comp_ie"),
      ...
      $"parsed.BPe.infBPe.imp.IBSCBS.CST".as("ibscbs_cst"),
      $"parsed.BPe.infBPe.imp.IBSCBS.cClassTrib".as("ibscbs_cclasstrib"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gCBS.gRed.pAliqEfet".as("gcbs_gred_paliqefet"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gCBS.gRed.pRedAliq".as("gcbs_gred_predaliq"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gCBS.pCBS".as("gcbs_pcbs"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gCBS.vCBS".as("gcbs_vcbs"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pAliqEfet".as("gibsmun_gred_paliqefet"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pRedAliq".as("gibsmun_gred_predaliq"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSMun.pIBSMun".as("gibsmun_pibsmun"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSMun.vIBSMun".as("gibsmun_vibsmun"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSUF.gRed.pAliqEfet".as("gibsuf_gred_paliqefet"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSUF.gRed.pRedAliq".as("gibsuf_gred_predaliq"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSUF.pIBSUF".as("gibsuf_pibsuf"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.gIBSUF.vIBSUF".as("gibsuf_vibsuf"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.vBC".as("ibscbs_vbc"),
      $"parsed.BPe.infBPe.imp.IBSCBS.gIBSCBS.vIBS".as("ibscbs_vibs"),
      $"parsed.BPe.infBPe.imp.vTotDFe".as("imp_vtotdfe"),
