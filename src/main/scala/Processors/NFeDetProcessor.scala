...
object NFeDetProcessor {
  ...
  def buildSelectedDF(parquetDF: DataFrame, schema: org.apache.spark.sql.types.StructType)
    ...
    val selectedDF = parsedDF.select(
      ...
      .select(
        ...
        $"det.imposto.ICMS.ICMS51.cBenefRBC".as("ICMS51_cBenefRBC"),
        ...
        $"det.imposto.ICMS.ICMS51.pFCP".as("ICMS51_pFCP"),
        $"det.imposto.ICMS.ICMS51.pFCPDif".as("ICMS51_pFCPDif"),
        ...
        $"det.imposto.ICMS.ICMS51.vBCFCP".as("ICMS51_vBCFCP"),
        $"det.imposto.ICMS.ICMS51.vFCP".as("ICMS51_vFCP"),
        $"det.imposto.ICMS.ICMS51.vFCPDif".as("ICMS51_vFCPDif"),
        $"det.imposto.ICMS.ICMS51.vFCPEfet".as("ICMS51_vFCPEfet"),
        ...
        $"det.imposto.ICMS.ICMS70.pFCPST".as("ICMS70_pFCPST"),
        $"det.imposto.ICMS.ICMS70.vBCFCPST".as("ICMS70_vBCFCPST"),
        $"det.imposto.ICMS.ICMS70.vFCPST".as("ICMS70_vFCPST"),
        ...
        $"det.imposto.ICMS.ICMS90.motDesICMSST".as("ICMS90_motDesICMSST"),
        ...
        $"det.imposto.ICMS.ICMS90.vFCPST".as("ICMS90_vFCPST"),
        ...
        $"det.imposto.ICMS.ICMS90.vICMSSTDeson".as("ICMS90_vICMSSTDeson"),
