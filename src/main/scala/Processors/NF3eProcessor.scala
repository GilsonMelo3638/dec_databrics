...
object NF3eProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.NF3e.infNF3e._versao".as("infnf3e_versao"),
      $"parsed.NF3e.infNF3e.autXML".as("autxml"),
      ...
      $"parsed.NF3e.infNF3e.dest.enderDest.fone".as("enderdest_fone"),
      ...
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.CEP".as("endercorresp_cep"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.UF".as("endercorresp_uf"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.cMun".as("endercorresp_cmun"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.fone".as("endercorresp_fone"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.nro".as("endercorresp_nro"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.xBairro".as("endercorresp_xbairro"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.xCpl".as("endercorresp_xcpl"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.xLgr".as("endercorresp_xlgr"),
      $"parsed.NF3e.infNF3e.gFat.enderCorresp.xMun".as("endercorresp_xmun"),
      ...
      $"parsed.NF3e.infNF3e.gSCEE.tpPartComp".as("gscee_tppartcomp"),
      $"parsed.NF3e.infNF3e.gSCEE.gConsumidor".as("gscee_gconsumidor"),
      $"parsed.NF3e.infNF3e.gSCEE.gSaldoCred".as("gscee_gsaldocred"),
      $"parsed.NF3e.infNF3e.gTarif".as("gtarif"),
      $"parsed.NF3e.infNF3e.gAdBand".as("gadband"),
      ...
      $"parsed.NF3e.infNF3e.gRespTec.hashCSRT".as("gresptec_hashcsrt"),
      $"parsed.NF3e.infNF3e.gRespTec.idCSRT".as("gresptec_idcsrt"),
      ...
      $"parsed.NF3e.infNF3e.ide.gCompraGov.tpOperGov".as("ide_gcompragov_tpopergov"),
