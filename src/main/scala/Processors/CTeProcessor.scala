...
object CTeProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.CTe.infCte.imp.IBSCBS.CST".as("ibscbs_cst"),
      $"parsed.CTe.infCte.imp.IBSCBS.cClassTrib".as("ibscbs_cclasstrib"),

      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gCBS.gDevTrib.vDevTrib".as("gdevtrib_vdevtrib"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gCBS.gRed.pAliqEfet".as("gred_paliqefet"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gCBS.gRed.pRedAliq".as("gred_predaliq"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gCBS.pCBS".as("gcbs_pcbs"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gCBS.vCBS".as("gcbs_vcbs"),

      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gDevTrib.vDevTrib".as("gdevtrib_vdevtrib_ibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pAliqEfet".as("gred_paliqefet_ibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pRedAliq".as("gred_predaliq_ibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.pIBSMun".as("gibsmun_pibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.vIBSMun".as("gibsmun_vibsmun"),

      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.gDevTrib.vDevTrib".as("gdevtrib_vdevtrib_ibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.gRed.pAliqEfet".as("gred_paliqefet_ibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.gRed.pRedAliq".as("gred_predaliq_ibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.pIBSUF".as("gibsuf_pibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.vIBSUF".as("gibsuf_vibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.CSTReg".as("gtribregular_cstreg"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.cClassTribReg".as("gtribregular_cclasstribreg"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.pAliqEfetRegCBS".as("gtribregular_paliqefetregcbs"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.pAliqEfetRegIBSMun".as("gtribregular_paliqefetregibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.pAliqEfetRegIBSUF".as("gtribregular_paliqefetregibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.vTribRegCBS".as("gtribregular_vtribregcbs"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.vTribRegIBSMun".as("gtribregular_vtribregibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribRegular.vTribRegIBSUF".as("gtribregular_vtribregibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.vBC".as("gibscbs_vbc"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.vIBS".as("gibscbs_vibs"),
      $"parsed.CTe.infCte.imp.IBSCBS.indDoacao".as("ibscbs_inddoacao"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribCompraGov.pAliqCBS".as("gtribcompragov_paliqcbs"),
     $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribCompraGov.pAliqIBSMun".as("gtribcompragov_paliqibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribCompraGov.pAliqIBSUF".as("gtribcompragov_paliqibsuf"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribCompraGov.vTribCBS".as("gtribcompragov_vtribcbs"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribCompraGov.vTribIBSMun".as("gtribcompragov_vtribibsmun"),
      $"parsed.CTe.infCte.imp.IBSCBS.gIBSCBS.gTribCompraGov.vTribIBSUF".as("gtribcompragov_vtribibsuf"),
      $"parsed.CTe.infCte.imp.vTotDFe".as("imp_vtotdfe"),
      ...
      $"parsed.CTe.infCte.infCTeNorm.infCteSub.refCteAnu".as("infctesub_refcteanu"),
      ...
      $"parsed.CTe.infCte.infCTeNorm.infDoc.infDCe.chave".as("infdce_chave"),
      ...
      $"parsed.CTe.infCte.infCTeNorm.infModal.duto.codPontoEntrada".as("duto_codpontoentrada"),
      $"parsed.CTe.infCte.infCTeNorm.infModal.duto.codPontoSaida".as("duto_codpontosaida"),
      $"parsed.CTe.infCte.infCTeNorm.infModal.duto.tpContratacao".as("duto_tpcontratacao"),
