...
object CTeOSProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.gDevTrib.vDevTrib".as("gDevTrib_vDevTrib"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.gRed.pAliqEfet".as("gRed_pAliqEfet"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.gRed.pRedAliq".as("gRed_pRedAliq"),
      ...
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gDevTrib.vDevTrib".as("gDevTrib_vDevTrib"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pAliqEfet".as("gRed_pAliqEfet"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pRedAliq".as("gRed_pRedAliq"),
