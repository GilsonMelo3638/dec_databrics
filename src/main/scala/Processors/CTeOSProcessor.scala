...
object CTeOSProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.CTeOS.infCte.imp.IBSCBS.CST".as("IBSCBS_CST"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.cClassTrib".as("IBSCBS_cClassTrib"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.gDevTrib.vDevTrib".as("gCBS_gDevTrib_vDevTrib"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.gRed.pAliqEfet".as("gCBS_gRed_pAliqEfet"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.gRed.pRedAliq".as("gCBS_gRed_pRedAliq"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.pCBS".as("gCBS_pCBS"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gCBS.vCBS".as("gCBS_vCBS"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gDevTrib.vDevTrib".as("gIBSMun_gDevTrib_vDevTrib"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pAliqEfet".as("gIBSMun_gRed_pAliqEfet"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.gRed.pRedAliq".as("gIBSMun_gRed_pRedAliq"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.pIBSMun".as("gIBSMun_pIBSMun"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.vIBSMun".as("gIBSMun_vIBSMun"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.gDevTrib.vDevTrib".as("gDevTrib_vDevTrib"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.gRed.pAliqEfet".as("gRed_pAliqEfet"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.gRed.pRedAliq".as("gRed_pRedAliq"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.pIBSUF".as("gIBSUF_pIBSUF"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.vIBSUF".as("gIBSUF_vIBSUF"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.vBC".as("gIBSCBS_vBC"),
      $"parsed.CTeOS.infCte.imp.IBSCBS.gIBSCBS.vIBS".as("gIBSCBS_vIBS"),
      $"parsed.CTeOS.infCte.imp.vTotDFe".as("imp_vTotDFe"),
