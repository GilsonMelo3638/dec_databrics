...
object NFComEventoProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed.eventoNFCom.infEvento.detEvento.evCancNFCom.chNFComAjuste".as("evCancNFCom_chNFComAjuste"),
      ...
      $"parsed.eventoNFCom.infEvento.detEvento.evSubNFCom.chNFComSubstituta".as("evSubNFCom_chNFComSubstituta"),
      $"parsed.eventoNFCom.infEvento.detEvento.evSubNFCom.descEvento".as("evSubNFCom_descEvento"),
      $"parsed.eventoNFCom.infEvento.detEvento.evSubNFCom.nProt".as("evSubNFCom_nProt"),
      $"parsed.eventoNFCom.infEvento.detEvento.evSubNFCom.xJust".as("evSubNFCom_xJust"),
