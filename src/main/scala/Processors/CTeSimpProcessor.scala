...
object CTeSimpProcessor {
  def generateSelectedDF(parsedDF: DataFrame)(implicit spark: SparkSession): DataFrame = {
    ...
    parsedDF.select(
      ...
      $"parsed._ipTransmissor".as("_ipTransmissor"),
      $"parsed._nPortaCon".as("_nPortaCon"),
...
//      $"parsed.CTeSimp.infCte._Id".as("cte_Id"),
      ...
      $"parsed.CTeSimp.infCte.autXML.CNPJ".as("autXML_CNPJ"),
      $"parsed.CTeSimp.infCte.autXML.CPF".as("autXML_CPF"),
      $"parsed.CTeSimp.infCte.cobr.dup.nDup".as("dup_nDup"),
      $"parsed.CTeSimp.infCte.cobr.dup.vDup".as("dup_vDup"),
      $"parsed.CTeSimp.infCte.cobr.fat.nFat".as("fat_nFat"),
      $"parsed.CTeSimp.infCte.cobr.fat.vOrig".as("fat_vOrig"),
      $"parsed.CTeSimp.infCte.cobr.fat.vLiq".as("fat_vLiq"),
      ...
      $"parsed.CTeSimp.infCte.emit.enderEmit.xCpl".as("emit_xCpl"),
      ...
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMS45.CST".as("icms45_CST"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMS90.CST".as("icms90_CST"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMS90.pICMS".as("icms90_pICMS"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMS90.vBC".as("icms90_vBC"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMS90.vICMS".as("icms90_vICMS"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMS90.vCred".as("icms90_vCred"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMSSN.CST".as("icmssn_CST"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMSSN.indSN".as("icmssn_indSN"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMSOutraUF.CST".as("icmsOutraUF_CST"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMSOutraUF.pICMSOutraUF".as("icmsOutraUF_pICMSOutraUF"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMSOutraUF.vBCOutraUF".as("icmsOutraUF_vBCOutraUF"),
      $"parsed.CTeSimp.infCte.imp.ICMS.ICMSOutraUF.vICMSOutraUF".as("icmsOutraUF_vICMSOutraUF"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.pFCPUFFim".as("icmsUFFim_pFCPUFFim"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.pICMSInter".as("icmsUFFim_pICMSInter"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.pICMSUFFim".as("icmsUFFim_pICMSUFFim"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.vBCUFFim".as("icmsUFFim_vBCUFFim"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.vFCPUFFim".as("icmsUFFim_vFCPUFFim"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.vICMSUFFim".as("icmsUFFim_vICMSUFFim"),
      $"parsed.CTeSimp.infCte.imp.ICMSUFFim.vICMSUFIni".as("icmsUFFim_vICMSUFIni"),
      $"parsed.CTeSimp.infCte.imp.vTotTrib".as("vTotTrib"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.CST".as("ibscbs_CST"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.cClassTrib".as("ibscbs_cClassTrib"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.vBC".as("ibscbs_vBC"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.vIBS".as("ibscbs_vIBS"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.gCBS.pCBS".as("pCBS"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.gCBS.vCBS".as("vCBS"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.pIBSMun".as("pIBSMun"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.gIBSMun.vIBSMun".as("vIBSMun"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.pIBSUF".as("pIBSUF"),
      $"parsed.CTeSimp.infCte.imp.IBSCBS.gIBSCBS.gIBSUF.vIBSUF".as("vIBSUF"),
      $"parsed.CTeSimp.infCte.imp.infAdFisco".as("infAdFisco"),
      ...
      $"parsed.CTeSimp.infCte.infCarga.xOutCat".as("xOutCat"),
      ...
      $"parsed.CTeSimp.infCte.toma.enderToma.xCpl".as("toma_xCpl"),
      ...
      $"parsed.CTeSimp.infCte.total.vTotDFe".as("vTotDFe"),
