...
object ExternalTablesDeleter {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tables = List(
      ...
      "dec_exadata_cte_ctesimp", "dec_exadata_cte_gvte", "dec_exadata_mdfe_mdfe", "dec_exadata_mdfe_cancelamento",
      "dec_exadata_nf3e_nf3e", "dec_exadata_nf3e_cancelamento", "dec_exadata_nfce_cancelamento", "dec_exadata_nfe_cancelamento"
    )
