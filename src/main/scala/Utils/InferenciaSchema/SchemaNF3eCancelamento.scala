...
object SchemaNF3eCancelamento {
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read.format("xml").option("rowTag", "procEventoNF3e").load("/datalake/bronze/sources/dbms/dec/nf3e_cancelamento/202307_202502")
...
//SchemaNF3eCancelamento.main(Array())