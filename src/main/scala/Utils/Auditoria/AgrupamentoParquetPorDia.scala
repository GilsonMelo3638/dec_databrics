...
object AgrupamentoParquetPorDia {
  def main(args: Array[String]): Unit = {
    ...
    val tiposDocumentos = Seq(
      "bpe", "cte", "mdfe", "nf3e", "nfcom", "nfe", "nfce",
      "nfe_cancelamento", "nfce_cancelamento", "cte_cancelamento", "nf3e_cancelamento",
      "bpe_cancelamento", "mdfe_cancelamento", "nfcom_cancelamento",
...
//AgrupamentoParquetPorDia.main(Array())import org.apache.spark.sql.{DataFrame, SparkSession}
import org.apache.spark.sql.functions.{col, substring, lit, concat}
import org.apache.hadoop.fs.{FileSystem, Path}
