...
object ExternalTablesDeleter {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tables = List(
      ...
      "dec_exadata_mdfe_cancelamento", "dec_exadata_nf3e_nf3e", "dec_exadata_nfcom_nfcom", "dec_exadata_nf3e_cancelamento", "dec_exadata_nfcom_cancelamento",
      "dec_exadata_nfce_cancelamento", "dec_exadata_nfe_cancelamento", "dec_exadata_nfe_evento", "dec_exadata_nf3e_evento", "dec_exadata_nfcom_evento", "dec_exadata_mdfe_evento"
    )
