...
object MDFeProc {
  ...
  val mesInicio = 3
  val mesFim = 3
  val tipoDocumento = "mdfe_evento"

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("ExtractLegadoEventoMDFe").enableHiveSupport().getOrCreate()
    ...
    anoMesList.foreach { anoMes =>
      val parquetPath = s"/datalake/bronze/sources/dbms/dec/mdfe_evento/20259820"
      ...
      repartitionedDF
        ...
        .save("/datalake/prata/sources/dbms/dec/mdfe/evento")
