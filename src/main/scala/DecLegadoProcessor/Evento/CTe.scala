...
object CTe {
  ...
  val mesInicio = 3
  val mesFim = 3
  val tipoDocumento = "cte_evento"

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("ExtractLegadoEventoCTe").enableHiveSupport().getOrCreate()
    ...
    anoMesList.foreach { anoMes =>
      val parquetPath = s"/datalake/bronze/sources/dbms/legado/dec/cte_evento_diario"
      ...
      repartitionedDF
        ...
        .save("/datalake/prata/sources/dbms/dec/cte/evento")
