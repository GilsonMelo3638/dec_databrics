...
object NFCom {
  ...
  val mesInicio = 3
  val mesFim = 3
  val tipoDocumento = "nfcom_evento"

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("ExtractLegadoEventoNFCom").enableHiveSupport().getOrCreate()
    ...
    anoMesList.foreach { anoMes =>
      val parquetPath = s"/datalake/bronze/sources/dbms/dec/nfcom_evento/202501_202510"
      ...
      repartitionedDF
        ...
        .save("/datalake/prata/sources/dbms/dec/nfcom/evento")
