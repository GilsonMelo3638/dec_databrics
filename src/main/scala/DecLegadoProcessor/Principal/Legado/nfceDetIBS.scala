...
object nfceDetIBS {
  ...
  def main(args: Array[String]): Unit = {
    ...
    anoMesList.foreach { anoMes =>
      ...
      // 2. Seleciona as colunas XML_DOCUMENTO_CLOB e NSU
      ...
      repartitionedDF
        ...
        .option("parquet.block.size", 256 * 1024 * 1024) // 500 MB
        .partitionBy("chave_particao") // Garante a separação por partição
        .save("/datalake/prata/sources/dbms/dec/nfce/detIBS/")
