...
object InfNFCe {
  ...
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("ExtractNFCe").enableHiveSupport().getOrCreate()
    ...
    val schema = NFCeSchema.createSchema()
      ...
      anoMesList.foreach { anoMes =>
        val parquetPath = s"/datalake/bronze/sources/dbms/dec/nfce_diario/year=2022"
