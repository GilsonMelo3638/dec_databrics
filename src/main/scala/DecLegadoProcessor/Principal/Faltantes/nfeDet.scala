...
import Processors.NFeDetProcessor
...
object nfeDet {
  ...
  def main(args: Array[String]): Unit = {
    ...
    anoMesList.foreach { anoMes =>
      val parquetPath = s"/datalake/bronze/sources/dbms/dec/diario/nfe/year=2026/month=04"
      ...
      //parsedDF.printSchema() // Verifica o esquema após o parsing

        // 4. Seleciona as colunas desejadas
        val selectedDF = NFeDetProcessor.buildSelectedDF(parquetDF, schema)(spark)
...
//      }
      ...
      repartitionedDF
        ...
        .save("/datalake/prata/sources/dbms/dec/nfe4/det/")
